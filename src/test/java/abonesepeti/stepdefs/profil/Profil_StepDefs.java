...
public class Profil_StepDefs {
    ...
    public void kullaniciSifremiDegistirButonunaTiklar() { profilPage.Sifremi_Degistir.click();
    }

    @When("Mevcut Sifre alanina eski sifre girilir")
    public void mevcutSifreAlaninaEskiSifreGirilir() {profilPage.Mevcut_Sifre.sendKeys("123456");//mevcut sifre
    }


    @When("Yeni Sifre alanina valid eski sifreden farkli sifre girilir")
    public void yeniSifreAlaninaValidEskiSifredenFarkliSifreGirilir() {profilPage.Yeni_Sifre.sendKeys("1234567");
    }


    @When("Yeni Sifre Dogrulama alanina bir onceki stepte girilen sifre girilir")
    public void yeniSifreDogrulamaAlaninaBirOncekiStepteGirilenSifreGirilir() {profilPage.YeniSifre_Dogrulama.sendKeys("1234567");
    }
