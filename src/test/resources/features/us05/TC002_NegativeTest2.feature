@us05
Feature: US05 Onceden kayitli bilgiler ile (Yeni hesap olustur butonu ile) Yeni Hesap Olusturamamali
  Scenario Outline: TC02 Yeni Hesap Olusturamama - negative Senaryo
