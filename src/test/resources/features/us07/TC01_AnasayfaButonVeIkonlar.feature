...
Feature: US07 Abone Sepeti Anasayfasındaki ikonlar ve butonlar tiklanabilir ve erisilebilir olmalı
  Scenario: TC001
    ...
    #Abonesepeti mobil uygulamasında "Anasayfaya" girilir
    #Anasayfada sağ üstte "Profil" linki görülür ve tıklanır
    #Anasayfada sağ üstte "Profil" linkinin tıklanabildiğini doğrula
    #Anasayfada sol üstte "Bildirimler" linki görülür ve tıklanır
    #Anasayfada sol üstte "Bildirimler" linkinin tıklanabildiğini  doğrula
    #Anasayfada "Hane1" linki görülür ve tıklanır
    #Anasayfada "Hane1" linkinin tıklanabildiğini doğrula
    #Anasayfada "Hane2" linki görülür ve tıklanır
    #Anasayfada "Hane2"  linkinin tıklanabildiğini doğrula
    #Anasayfada "Tümünü Göster" linki görülür ve tıklanır
    #Anasayfada "Tümünü Göster" linkinin tıklanabildiğini doğrula
    #Anasayfada "Güncel Ay" linki görülür ve tıklanır
    #Anasayfada "Güncel Ay" linkinin tıklanabildiğini doğrula
    #Anasayfada "Son 6 Ay" linki görülür ve tıklanır
    #Anasayfada "Son 6 Ay" linkinin tıklanabildiğini doğrula